...
###export###
export PATH
export FRPS_VER=0.24.1
export FRPS_INIT="https://raw.githubusercontent.com/xiucaiwu/frp-onekey/master/frps.init"
export aliyun_download_url="https://code.aliyun.com/xiuwu_just/frp-onekey/raw/master"
...
str_install_shell="https://raw.githubusercontent.com/xiucaiwu/frp-onekey/master/install-frps.sh"
shell_update(){
    fun_clangcn "clear"
